...
If they don't have Obsidian installed yet, point them at [the Obsidian setup guide](https://github.com/jdpolasky/chief-of-staff-2/blob/main/obsidian-setup.md) and offer to pause while they set it up. Do not try to install Obsidian for them.
