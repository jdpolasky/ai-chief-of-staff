...
If they don't have Obsidian installed yet, point them at [`obsidian-setup`](../../../obsidian-setup.md) and offer to pause while they set it up. Do not try to install Obsidian for them.
